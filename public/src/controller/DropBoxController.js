class DropBroxController{

    constructor(){

        this.onslectionchange = new Event ('selectionchange');  
    ...
    connectFirebase(){
        ...
        var firebaseConfig = {
            apiKey: "AIzaSyDUjOyVm8_gn65xVJ6q9qz4uKzcxj3I_F8",
            authDomain: "dropbox-clone-a2a24.firebaseapp.com",
            databaseURL: "https://dropbox-clone-a2a24.firebaseio.com",
            projectId: "dropbox-clone-a2a24",
            storageBucket: "",
            messagingSenderId: "190963261216",
            appId: "1:190963261216:web:5e2782569dba4f70"
        };
        // Initialize Firebase
        ...
        li.addEventListener('click', e=>{
            ...
            if(e.shiftKey){
                ...
                if(firstLi){
                    ...
                    this.listFilesEl.dispatchEvent(this.onslectionchange);
